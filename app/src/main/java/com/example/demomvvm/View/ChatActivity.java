...
import com.example.demomvvm.adapters.ChatAdapter;
import com.example.demomvvm.databinding.ActivityChatBinding;
...
public class ChatActivity extends BaseActivity {
    ...
    private Boolean isValidMessage() {
        if (TextUtils.isEmpty(binding.inputMessage.getText().toString().trim())) {
            showToast("Please enter message before sending");
            return false;
        } else {
            return true;
        }
